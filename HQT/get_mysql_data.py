...
class cal_apidemo_data(object):
    def __init__(self, own_dict, opp_dict):
        ...
        # self.own_data[ '' ][ '' ]
    # 状态比对
    def compare_tb_cli_order_rtn__order_status(self):
        """
        报单状态
    ...
    def cal_tb_account_funds_info__available(self):
        ...
        self.own_data[ 'tb_order_info_cal' ][ 'margin' ] = self.own_data[ 'tb_cli_insert_req' ][ 'limit_price' ] * \
                                                           ...
                                                           self.own_data[ 'tb_fee_ratio_info' ][self.own_data[ 'tb_cli_insert_req' ]['instrument_i_d' ] ]['long_margin_ratio_by_money' ] * \
                                                           self.own_data[ 'tb_cli_insert_req' ][
