...
def date_to_zhdate():
    ...
    try:
        ...
        print('农历年月日时：', zd.lunar_year, '年', zd.lunar_month, '月', zd.lunar_day, '日', shi[zd_hour], '时')
...
def xlr():
    ...
    while True:
        print('天后娘娘，观音菩萨，财神老爷在上，信男罗丙松敬拜众圣安。望明示解惑！此后逢年过节必三牲酒礼拜谢！')
        log_file.write(str(input('今次所询之事：'))+'\n')
